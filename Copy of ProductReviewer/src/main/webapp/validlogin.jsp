...
<!-- Facebook Login Button End -->
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li class="dropdown">
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Welcome <%=name %>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
     ...
     <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Refrigerator
       ...
       <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Air-Conditioner
                <span class="caret"></span></a>
        <ul class="dropdown-menu">
   ...
   <ul class="nav navbar-nav navbar-right">
    ...
    <div class="container-fluid">
       ...
       <div class="col-md-9">
            <div class="row" >
           <a href="Catagory.html"><h1>Refrigerators</h1></a>
           <div class="row" id="fridge">
              ...
              <!-- <div class="row">
                ...
                -->
              <div class="row" >
           <a href="#"><h1>Air-Conditioners</h1></a>  
