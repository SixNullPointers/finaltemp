...
<!-- Facebook Login Button End -->
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="Newindex.jsp">GoGrabIt</a>
    </div>
    <ul class="nav navbar-nav">
     <li class="active"><a href="Newindex.jsp">Home</a></li>
     <li class="dropdown">
        <a    href="category.jsp?param=Refrigerator">Refrigerator </a>
      </li>
       <li class="dropdown">
        <a  href="category.jsp?param=Air Conditioner">Air Conditioner
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown"  href="category.jsp?param=Mobile">Mobile
       </a>
      <!--   <ul class="dropdown-menu">
    ...
    <div class="container-fluid">
       ...
       <div class="col-md-9">
            <div class="row" >
           <a href="category.jsp?param=Refrigerator"><h1>Refrigerator</h1></a>
           ...
           <a href="category.jsp?param=Iron"><h1>Iron</h1></a>  
              ...
              <div class="row" id="ac">
                ...
                <div class="row">
             <a href="category.jsp?param=Air Conditioner"> <h1>Air Conditioner</h1></a>  
